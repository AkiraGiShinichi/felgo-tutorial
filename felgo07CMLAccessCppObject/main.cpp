...
int main(int argc, char *argv[])
{
    ...
    // Example 1: add global c++ object to the QML context as a property
    MyGlobalObject *myGlobal = new MyGlobalObject();
    myGlobal->doSomething("TEXT LINH TINH"); // this code just is foo test
    engine.rootContext()->setContextProperty("myGlobalObject", myGlobal);

    // Example 2: register a QML type made with C++
